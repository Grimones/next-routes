  ...
  _createClass(Routes, [{
    ...
    value: function findAndGetUrls(nameOrUrl, params) {
      ...
      if (route) {
        ...
        var href = _route ? _route.getHref(_objectSpread({}, params, query)) : nameOrUrl;
        var as = _route ? _route.getAs(params, nameOrUrl) : nameOrUrl;
        var urls = {
          href: href,
          as: as
        };
...
function () {
  ...
  _createClass(Route, [{
    ...
    value: function getAs() {
      ...
      var _as = arguments.length > 1 ? arguments[1] : undefined;

      var as = _as || this.toPath(params) || '/';
